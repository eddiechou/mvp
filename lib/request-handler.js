...
exports.insertPromise = function(req, res) {
  ...
  var promiseOptions = {};
  promiseOptions.byUser = req.body.byUser || 'Eddie';
  promiseOptions.toUser = req.body.toUser || 'Erik';
  promiseOptions.description = req.body.description || 'Whiteboard';
  promiseOptions.status = req.body.status || 'pending';
